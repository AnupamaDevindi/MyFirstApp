...
<head>
    ...
    <title>Login | ABC COURSEWEB</title>
...
<body>
    <div>
        ...
        <div class="login-card" style="margin-top:112px;"><img src="assets/img/avatar_2x.png" class="profile-img-card">
            ...
            <form action="registerServlet" method="post" class="form-signin"><span class="reauth-email"> </span>
            ...
            <input name="passwd" class="form-control" type="password" required="required" placeholder="Password" >
                <input
                    ...
                    <div class="container d-flex" style="margin-top:-9px;">
                        <div class="form-check" style="width:95px;"><input class="form-check-input" type="radio" name="memberCheck" value="lecturer" checked="checked" id="formCheck-2" style="padding-left:0px;margin-left:-16px;"><label class="form-check-label d-inline-flex" for="formCheck-2" style="width:90px;padding-left:7px;">Lecturer</label></div>
                        <div
                            class="form-check" style="width:115px;padding-left:64px;"><input class="form-check-input" type="radio" name="memberCheck" value="admin" id="formCheck-1"><label class="form-check-label" for="formCheck-1" style="margin-top:0px;margin-left:-1px;width:105px;margin-bottom:-16px;padding-top:-2px;">Admin</label></div>
        </div>
        <div class="checkbox">
