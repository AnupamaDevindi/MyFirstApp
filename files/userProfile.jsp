...
<HTML>
    ...
    <%
        ...
        PreparedStatement ps = conn.prepareStatement("Select User_ID,First_name,Last_name,Email,User_type,Role_ID,Contact_no,Status,Username,CreatedBy,CreatedDate From [User]");               
