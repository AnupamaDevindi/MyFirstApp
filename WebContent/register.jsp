...
<head>
	...
	function charCheck(){
		...
		var today = new Date();
		var date = new Date($('#date-inp').val());
		var year = today.getFullYear();
		var bday_year = date.getFullYear();	
		var nic = document.getElementById("nic").value;
		var pas = document.getElementById("pass");
		var conpas = document.getElementById("conpass");
		
		if (nic.length != 9)
			{
			alert("Check Your NIC number.(9 digits required)");	
			return false;
			}
   ...
   <div style="background-color:black" >
        <div class="row register-form">
            <div class="col-md-8 offset-md-2">
                <form class="custom-form" action="registerServlet" method="post">
                    ...
                    <input type="hidden" name="memberCheck" value="lecturer">
